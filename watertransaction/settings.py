"""
Django settings for watertransaction project.
...
SECRET_KEY = 'django-insecure-mv2*^8kvo7d=td$-1vyp-8zclejd2k70uueako6omzbcw9hme8'
...
ROOT_URLCONF = 'watertransaction.urls'
...
WSGI_APPLICATION = 'watertransaction.wsgi.application'
